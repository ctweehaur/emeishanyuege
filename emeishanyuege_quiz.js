...
const quizQuestions = [
    ...
    },
    {
        ...
        options: [
            { text: "春季 (Spring)", py: "chūn jì", en: "Spring", correct: false, explanation: "错误，春季景物与诗中的月相和秋色线索完全不符。", explanationPy: "cuò wù chūn jì jǐng wù yǔ shī zhōng de yuè xiàng hé qiū sè xiàn suǒ wán quán bù fú", explanationEn: "Incorrect. Spring scenery contradicts the explicit seasonal keywords in the text." },
            { text: "夏季 (Summer)", py: "xià jì", en: "Summer", correct: false, explanation: "错误，夏夜繁星繁茂，与全诗核心冷月意境不同。", explanationPy: "cuò wù xià jì fán xīng fán mào yǔ quán shī hé xīn lěng yuè yì jìng bù tóng", explanationEn: "Incorrect. The unique moon profile described does not match mid-summer conditions." },
            { text: "秋季 (Autumn)", py: "qiū jì", en: "Autumn", correct: true, explanation: "正确。第一句中的“半轮秋”直接点明了这是初秋或中秋过后的特有秋景。", explanationPy: "zhèng què dì yī jù zhōng de bàn lún qiū zhí jiē diǎn míng le zhè shì chū qiū huò zhōng qiū guò hòu de tè yǒu qiū jǐng", explanationEn: "Correct. 'Bàn lún qiū' in the very first line clearly identifies early or mid-autumn." },
            { text: "冬季 (Winter)", py: "dōng jì", en: "Winter", correct: false, explanation: "错误，冬景极度严寒，与全诗轻快、仗剑远游的阔大基调完全相左。", explanationPy: "cuò wù dōng jǐng jí dù yán hán yǔ quán shī qīng kuài zhàng jiàn yuǎn yóu de kuò dà jī tiào wán quán xiāng zuǒ", explanationEn: "Incorrect. Winter's freeze contradicts the energetic, wandering nature of Li Bai's trip." }
        ]
    }
];
